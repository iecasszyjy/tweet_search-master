...
from Config_Science_Technology_od import get_noau_config
...
if __name__ == '__main__':
    print('Science_Technology_od_worker start!')
    while True:
        # 从Redis数据库中取出获取开放域推文所需信息
        queue = r.lpop('Science_Technology_od')
        print('start queue redis!')
        if queue:
            print('Science_Technology_od_worker process!')
        ...
        time.sleep(1)
        print('Science_Technology_od_worker wait!')
