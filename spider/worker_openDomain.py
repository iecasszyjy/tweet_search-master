...
from Config_openDomain import get_noau_config
...
if __name__ == '__main__':
    print('openDomain_worker start!')
    while True:
        # 从Redis数据库中取出获取开放域推文所需信息
        queue = r.lpop('openDomain')
        print('start queue redis!')
        if queue:
            print('openDomain_worker process!')
