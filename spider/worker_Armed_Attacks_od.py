...
from Config_Armed_Attacks_od import get_noau_config
...
if __name__ == '__main__':
    print('Disasters_Accidents_od_worker start!')
    while True:
        # 从Redis数据库中取出获取开放域推文所需信息
        queue = r.lpop('Armed_Attacks_od')
        print('start queue redis!')
        if queue:
            print('Armed_Attacks_od_worker process!')
        ...
        time.sleep(1)
        print('Armed_Attacks_od_worker wait!')
