...
from Config_Health_Environment_od import get_noau_config
...
if __name__ == '__main__':
    print('Health_Environment_od_worker start!')
    while True:
        # 从Redis数据库中取出获取开放域推文所需信息
        queue = r.lpop('Health_Environment_od')
        print('start queue redis!')
        if queue:
            print('Health_Environment_od_worker process!')
        ...
        time.sleep(1)
        print('Health_Environment_od_worker wait!')
